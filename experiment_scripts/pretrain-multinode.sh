...
source /n/holylabs/LABS/dam_lab/Lab/sqin/envs/openrlhf/bin/activate
...
srun torchrun \
    ...
    /n/home05/sqin/OLMo/scripts/train.py /n/home05/sqin/OLMo/experiment_scripts/OLMo2-1B-stage1.yaml
